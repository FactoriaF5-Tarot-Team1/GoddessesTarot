...
function WomenSection() {
  return (
    <section className={styles.womenSection}>
      <article className={styles.womenSectionContainer}>
        ...
        <div className={styles.tarotDeckContent}>
          <div className={styles.stemTarotDivider}>
            <img
              src={flaskIcon}
              alt="Icono de una ampolla de laboratorio"
            ></img>
            <p>EL TAROT STEM</p>
          </div>
          <div className={styles.tarotDeckDescription}>
            ...
            <p>
              ...
              mentes brillantes que forjaron la ciencia y la tecnología. <br></br>
              Desde las astrónomas que cartografiaron el infinito hasta las
              matemáticas que descifraron el lenguaje de la creación.
            </p>
          </div>
        </div>
      </article>
      ...
      <div className={styles.starsContainer}>
        <img
          ...
          src={starsIcon}
          alt="Icono de decoración con tres estrellas"
        ></img>
      </div>
    </section>
  );
